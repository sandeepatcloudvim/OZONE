page 50038 "CBR Production BOM List"
{

    Permissions = tabledata 99000771 = rmid, tabledata 5405 = rmid, tabledata 90 = rmid;
    AdditionalSearchTerms = 'bill of materials';
    ApplicationArea = Manufacturing;
    Caption = 'CBR Production BOMs';
        ...
        area(processing)
        {
            action(UpdateStatus)
            {
                ...
                begin
                    ...
                    ProductionBomHeader.SetRange(Status, ProductionBomHeader.Status::"Under Development");
