report 50011 "CBR Purchase Order"
{
    DefaultLayout = RDLC;
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        //CBR_SS++
                        column(CBRVendorItemNo; CBRVendorItemNo)
                        {
                        ...
                        begin
                            ...
                            //CBR_SS++
                            CBRVendorItemNo := '';
                            if CBRItemRec.get("No.") then
                                CBRVendorItemNo := CBRItemRec."Vendor Item No.";
                            //CBR_SS--
    ...
    var
        ...
        CBRVendorItemNo: Code[50];
        AmountExclInvDisc: Decimal;
        ShipmentMethod: Record "Shipment Method";
        PaymentTerms: Record "Payment Terms";
        CBRItemRec: Record Item;
